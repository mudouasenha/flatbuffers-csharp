...
public struct VideoInfo : IFlatbufferObject
{
  ...
  public FlatBuffers.Sender.Video.VideoQuality Qualities(int j) { int o = __p.__offset(10); return o != 0 ? (FlatBuffers.Sender.Video.VideoQuality)__p.bb.GetShort(__p.__vector(o) + j * 2) : (FlatBuffers.Sender.Video.VideoQuality)0; }
  public int QualitiesLength { get { int o = __p.__offset(10); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FlatBuffers.Sender.Video.VideoQuality> GetQualitiesBytes() { return __p.__vector_as_span<FlatBuffers.Sender.Video.VideoQuality>(10, 2); }
#else
  public ArraySegment<byte>? GetQualitiesBytes() { return __p.__vector_as_arraysegment(10); }
#endif
  public FlatBuffers.Sender.Video.VideoQuality[] GetQualitiesArray() { int o = __p.__offset(10); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); FlatBuffers.Sender.Video.VideoQuality[] a = new FlatBuffers.Sender.Video.VideoQuality[l]; for (int i = 0; i < l; i++) { a[i] = (FlatBuffers.Sender.Video.VideoQuality)__p.bb.GetShort(p + i * 2); } return a; }

  public static Offset<FlatBuffers.Sender.Video.VideoInfo> CreateVideoInfo(FlatBufferBuilder builder,
      int duration = 0,
  ...
  public static VectorOffset CreateQualitiesVector(FlatBufferBuilder builder, FlatBuffers.Sender.Video.VideoQuality[] data) { builder.StartVector(2, data.Length, 2); for (int i = data.Length - 1; i >= 0; i--) builder.AddShort((short)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateQualitiesVectorBlock(FlatBufferBuilder builder, FlatBuffers.Sender.Video.VideoQuality[] data) { builder.StartVector(2, data.Length, 2); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateQualitiesVectorBlock(FlatBufferBuilder builder, ArraySegment<FlatBuffers.Sender.Video.VideoQuality> data) { builder.StartVector(2, data.Count, 2); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateQualitiesVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<FlatBuffers.Sender.Video.VideoQuality>(dataPtr, sizeInBytes); return builder.EndVector(); }
  public static void StartQualitiesVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(2, numElems, 2); }
  public static Offset<FlatBuffers.Sender.Video.VideoInfo> EndVideoInfo(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatBuffers.Sender.Video.VideoInfo>(o);
  }
}
