...
public struct Channel : IFlatbufferObject
{
  ...
  public static Offset<FlatBuffers.Sender.Video.Channel> CreateChannel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatBuffers.Sender.Video.Channel> EndChannel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatBuffers.Sender.Video.Channel>(o);
  }
}
