...
public struct VideoInfoFlatModel : IFlatbufferObject
{
  ...
  public Serialization.Domain.FlatBuffers.VideoModel.VideoQualityFlatModel Qualities(int j) { int o = __p.__offset(10); return o != 0 ? (Serialization.Domain.FlatBuffers.VideoModel.VideoQualityFlatModel)__p.bb.GetShort(__p.__vector(o) + j * 2) : (Serialization.Domain.FlatBuffers.VideoModel.VideoQualityFlatModel)0; }
...
#endif
  public Serialization.Domain.FlatBuffers.VideoModel.VideoQualityFlatModel[] GetQualitiesArray() { int o = __p.__offset(10); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); Serialization.Domain.FlatBuffers.VideoModel.VideoQualityFlatModel[] a = new Serialization.Domain.FlatBuffers.VideoModel.VideoQualityFlatModel[l]; for (int i = 0; i < l; i++) { a[i] = (Serialization.Domain.FlatBuffers.VideoModel.VideoQualityFlatModel)__p.bb.GetShort(p + i * 2); } return a; }

  public static Offset<Serialization.Domain.FlatBuffers.VideoModel.VideoInfoFlatModel> CreateVideoInfoFlatModel(FlatBufferBuilder builder,
      int duration = 0,
  ...
  public static VectorOffset CreateQualitiesVector(FlatBufferBuilder builder, Serialization.Domain.FlatBuffers.VideoModel.VideoQualityFlatModel[] data) { builder.StartVector(2, data.Length, 2); for (int i = data.Length - 1; i >= 0; i--) builder.AddShort((short)data[i]); return builder.EndVector(); }
  public static VectorOffset CreateQualitiesVectorBlock(FlatBufferBuilder builder, Serialization.Domain.FlatBuffers.VideoModel.VideoQualityFlatModel[] data) { builder.StartVector(2, data.Length, 2); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateQualitiesVectorBlock(FlatBufferBuilder builder, ArraySegment<Serialization.Domain.FlatBuffers.VideoModel.VideoQualityFlatModel> data) { builder.StartVector(2, data.Count, 2); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateQualitiesVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Serialization.Domain.FlatBuffers.VideoModel.VideoQualityFlatModel>(dataPtr, sizeInBytes); return builder.EndVector(); }
  public static void StartQualitiesVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(2, numElems, 2); }
  public static Offset<Serialization.Domain.FlatBuffers.VideoModel.VideoInfoFlatModel> EndVideoInfoFlatModel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Serialization.Domain.FlatBuffers.VideoModel.VideoInfoFlatModel>(o);
  }
}
