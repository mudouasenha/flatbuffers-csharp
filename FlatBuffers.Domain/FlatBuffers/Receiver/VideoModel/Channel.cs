...
public struct Channel : IFlatbufferObject
{
  ...
  public static Offset<FlatBuffers.Receiver.VideoModel.Channel> CreateChannel(FlatBufferBuilder builder,
  ...
  public static Offset<FlatBuffers.Receiver.VideoModel.Channel> EndChannel(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatBuffers.Receiver.VideoModel.Channel>(o);
  }
}
