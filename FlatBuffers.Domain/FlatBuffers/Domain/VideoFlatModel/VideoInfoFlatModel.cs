...
public struct VideoInfoFlatModel : IFlatbufferObject
{
  ...
  public static VideoInfoFlatModel GetRootAsVideoInfo(ByteBuffer _bb) { return GetRootAsVideoInfo(_bb, new VideoInfoFlatModel()); }
  public static VideoInfoFlatModel GetRootAsVideoInfo(ByteBuffer _bb, VideoInfoFlatModel obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
...
#if ENABLE_SPAN_T
  public Span<FlatBuffers.Domain.VideoModel.VideoQuality> GetQualitiesBytes() { return __p.__vector_as_span<FlatBuffers.Receiver.VideoModel.VideoQuality>(10, 2); }
#else
  ...
  public static Offset<FlatBuffers.Domain.VideoModel.VideoInfoFlatModel> CreateVideoInfo(FlatBufferBuilder builder,
      int duration = 0,
    ...
    return VideoInfoFlatModel.EndVideoInfo(builder);
  }
  ...
  public static Offset<FlatBuffers.Domain.VideoModel.VideoInfoFlatModel> EndVideoInfo(FlatBufferBuilder builder) {
